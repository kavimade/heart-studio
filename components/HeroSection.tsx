...
const SLIDES = [
  ...
  { src: "/images/opening-01.webp", alt: "Heart Studio opening day" },
]
  ...
  return (
    <section id="home" className="relative h-screen min-h-[600px] overflow-hidden">
      ...
      <div
        ...
        style={{ background: "rgba(61, 56, 48, 0.42)" }}
      />

      {/* Content */}
      <div className="relative z-20 h-full flex flex-col justify-center px-6 md:px-16 lg:px-24 max-w-4xl">
        <h1 className="text-hs-white mb-5 drop-shadow-sm">
          Your practice deserves<br className="hidden sm:block" /> a real home.
        </h1>
        <p className="text-hs-white/85 text-lg md:text-xl leading-relaxed mb-8 max-w-lg font-light">
